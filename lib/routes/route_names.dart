...
import 'package:flutter_app/modules/hotel_booking/filter_screen/filters_screen.dart';
import 'package:flutter_app/modules/hotel_booking/hotel_home_screen.dart';
import 'package:flutter_app/modules/hotel_detailes/hotel_detailes.dart';
import 'package:flutter_app/modules/hotel_detailes/reviews_list_screen.dart';
import 'package:flutter_app/modules/hotel_detailes/room_booking_screen.dart';
import 'package:flutter_app/modules/hotel_detailes/search_screen.dart';
import 'package:flutter_app/modules/Login/change_password.dart';
...
class NavigationServices {
  ...
  Future<dynamic> gotoRoomBookingScreen(String hotelname, {HotelListData? hotelData}) async {
    return await _pushMaterialPageRoute(
        RoomBookingScreen(hotelName: hotelname, hotelData: hotelData));
  }
  ...
  Future<dynamic> gotoApiDemoScreen() async {
    return await _pushMaterialPageRoute(ApiDemoScreen());
  }
}
